  ...
  navbarPage(collapsible=TRUE,
    ...
    tabPanel(
      ...
      absolutePanel(
        ...
        br(),
        br(),
        h3("With this app you can find out which bird species in your life list have the highest",a(href="https://www.edgeofexistence.org/science/", target="_blank", strong("EDGE scores")), ". If you use eBird to keep track of your sightings, simply upload your eBird life list in the \"eBird life list\" tab. If you do not use eBird to keep track of your sightings, you can use the \"Explore\" tab to browse and select from the complete EDGE list of 10,960 bird species."),
               h3("EDGE scores are a product of how", strong("Evolutionary Distinctive (ED)"), "and", strong("Globall Endangered (GE)"),"a bird species is. The scores are produced and updated by the", a(href="http://www.zsl.org/", strong("Zoological Society of London (ZSL)")),"to highlight the need to preserve the world’s most unique and endangered species."),
               h3("Evolutionary Distinctiveness is a measure of how unique a species is based on the number and evolutionary distance of living relatives in the", a(href="http://datazone.birdlife.org/species/taxonomy", target="_blank",strong("BirdLife International")),"taxonomy. Global Endangerement status of each species is based on the", 
               ...
               h3("Abundant species that have many close relatives, such as most gulls (blue branches in the tree on the left), have low EDGE scores. While Critically Endangered species that have few living relatives, such as the California Condor (red branch), have a high EDGE score."),
               br(),
             ...
             absolutePanel(img(src="RTTB_04_2018.png",height="100%",width="100%",style="min-height:296px;min-width:1246px;max-height:318px;max-width:1340px;
                   ...
                   absolutePanel(img(src="black_patch.png",height="100%",width="100%",style="min-height:45px;min-width:45px;max-height:45;px;max-width:45px;
                               "),top=0,right=0),
             absolutePanel(h5("App by",a(href="https://www.sfu.ca/biology/people/profiles/svaldez.html", target="_blank", strong("Simón Valdez-Juarez")),"&",br(),a(href="http://sebpardo.github.io/", target="_blank", strong("Sebastián Pardo"))),top=1020,left=45, align = "center"),
