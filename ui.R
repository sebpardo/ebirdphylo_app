      ...
      absolutePanel(
        ...
        h3("Use this app to find out which bird species in your life list have the highest",a(href="https://www.edgeofexistence.org/science/", target="_blank", strong("EDGE scores")), ". If you use eBird to keep track of your sightings, simply upload your eBird life list in the \"eBird life list\" tab. If you do not use eBird to keep track of your sightings, you can use the \"Explore\" tab to browse and select from the complete EDGE list of 10,960 bird species in the" 
            ,a(href="http://datazone.birdlife.org/species/taxonomy", target="_blank",("BirdLife International")),"taxonomy."),
               h3("EDGE scores are a product of how", strong("Evolutionarily Distinctive (ED)"), "and", strong("Globally Endangered (GE)"),"a bird species is. Evolutionary Distinctiveness is a measure of how unique a species is, based on the number and of living relatives it has, and its evolutionary distance from these relatives. Global Endangerment status for each species is based on the", 
             ...
             absolutePanel(img(src="RTTB_04_2018.png",height="100%",width="100%",style="min-height:296px;min-width:1246px;max-height:318px;max-width:1340px;
                   ...
                   absolutePanel(img(src="black_patch.png",height="100%",width="100%",style="min-height:45px;min-width:45px;max-height:45;px;max-width:45px;
                               "),top=0,right=0),
             absolutePanel(h5("App by",a(href="https://www.sfu.ca/biology/people/profiles/svaldez.html", target="_blank",("Simón Valdez-Juarez")),"&",br(),a(href="http://sebpardo.github.io/", target="_blank", ("Sebastián Pardo"))),top=1020,left=45, align = "center"),
